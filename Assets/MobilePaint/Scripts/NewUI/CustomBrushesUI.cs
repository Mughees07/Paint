...
namespace unitycoder_MobilePaint
{
	public class CustomBrushesUI : MonoBehaviour {
		...
		public MobilePaint mobilePaint2;
		public MobilePaint mobilePaint3;
		public MobilePaint mobilePaint4;
		...
		public void SetCustomBrush(int index)
		{
			...
			mobilePaint2.selectedBrush = index;
			mobilePaint2.ReadCurrentCustomBrush();
			mobilePaint3.selectedBrush = index;
			mobilePaint3.ReadCurrentCustomBrush();
			mobilePaint4.selectedBrush = index;
			mobilePaint4.ReadCurrentCustomBrush();
